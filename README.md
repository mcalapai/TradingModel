...
As we can see from the feature importances, the FFT coefficient for the Volume Oscillator indicator is one of the most relevant features in predicting the outcome of the manually generated signal. This makes sense, as the strategy is based on abnormally large values in the volume oscillator.
